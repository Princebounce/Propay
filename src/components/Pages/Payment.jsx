...
const Payment = () => {
  return (
    <div className="flex flex-col items-center  min-h-screen mt-4 bg-customGray">
      <div className="container mx-auto">
        {/* First Card */}
        <div className="w-full max-w-screen-md mx-auto mb-4">
          <div className="border p-2 w-full rounded-lg bg-slate-50 flex justify-between items-center shadow-lg">
            <div className="flex">
              <div className="mr-3">
        ...
        {/* Second Card */}
        <div className="border p-4 bg-slate-50 rounded-lg w-full shadow-lg mb-4">
